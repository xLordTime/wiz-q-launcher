...
- **Legacy update compatibility strengthened** — updater now reads both modern and legacy staged filenames and refreshes legacy alias files after download for backward-compatible update flow
